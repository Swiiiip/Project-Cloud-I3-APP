...
class EmojiCatalogServiceApp:
    ...
    def _register_routes(self) -> None:
        self._app.add_api_route("/internal/emoji_catalog/supported_emojis", self._get_supported_emojis, methods=["GET"])
        self._app.add_api_route("/internal/emoji_catalog/health", self._health, methods=["GET"])
